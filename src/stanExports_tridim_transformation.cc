...
#include "stanExports_tridim_transformation.h"

RCPP_MODULE(stan_fit4tridim_transformation_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_tridim_transformation")
